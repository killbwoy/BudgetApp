...
try{
    ...
    // Pobranie kategorii przychodów z bazy danych
    ...
    // Pobranie kategorii przychodow z bazy danych
    $categories = [];
    $sql = "SELECT name FROM incomes_category_assigned_to_users WHERE userId = ?";
          ...
          <div class="" id="income-section">
            ...
            <div id="inside" class="my-form">
              <form action="dodajPrzychod.php" method="POST">
                <p> Kwota <input type="number" step="0.01" name="number" id="inputNumber"></p>
                ...
                <p> Uwagi <input type="text" name="cautions" id="inputText"></p>
                <p>
